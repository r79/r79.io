...
public class HelloWorldXMLClient {
    ...
    */
			...
			Object o = context.lookup("ejb:MyEAR/MyEJB/HelloWorldXMLBean!server.HelloWorldXML");
			...
			hello = (HelloWorldXML) PortableRemoteObject.narrow(o, HelloWorldXML.class);

			// ODER: Instanziierung des Business Interface durch Type-Casting des Proxy
			hello = (HelloWorldXML) o;
